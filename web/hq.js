...
export {itemTitle,isDenimItem} from './item-title.js?v=20260809-live-title';
...
export async function shell(active){
  ...
  $('login').onclick=async()=>{
    const {error}=await sb.auth.signInWithOAuth({provider:'github',options:{scopes:'repo',redirectTo:location.origin+location.pathname}});
