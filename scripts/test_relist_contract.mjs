...
const migration=readFileSync(new URL('../supabase/migrations/055_atomic_relist_contract.sql',import.meta.url),'utf8');
...
assert.match(operations,/RELIST DO POTWIERDZENIA/,'Operations must merge missing and unlinked evidence into one relist decision.');
