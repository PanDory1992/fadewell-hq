...
assert.match(source, /gmail\.modify/, 'OAuth must request the minimum scope that can move a message to Trash.');
assert.match(source, /trash_backfill_completed_at:\s*null/, 'A fresh permission grant must schedule one bounded trash backfill.');
