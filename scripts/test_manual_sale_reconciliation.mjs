...
const sync=await readFile(resolve(root,'supabase/functions/hq-gmail-ingest/index.ts'),'utf8');
...
assert.match(sync,/rpc\/reconcile_hq_manual_sale_evidence/,'The Apps Script Gmail intake must invoke the reconciliation.');
