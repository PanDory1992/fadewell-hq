-- 034 was recorded after a rejected management-API request and made no schema
-- change. Reapply the idempotent KROK 2 schema without deleting that audit fact.
-- Evidence only: this migration never changes a DEN or ledger event.
